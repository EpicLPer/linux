...
static const struct camss_subdev_resources vfe_res_8x94[] = {
	/* VFE0 */
	{
		...
		.clock_rate = { { 0 },
				{ 0 },
				/* ACPI VFE0 P-states / mmcc ftbl_vfe0_clk_src */
				{ 80000000, 100000000, 200000000, 320000000,
				  400000000, 480000000, 533330000, 600000000 },
				{ 0 },
				{ 0 },
				{ 0 } },
		.reg = { "vfe0" },
	...
	/* VFE1 */
	{
		...
		.clock_rate = { { 0 },
				{ 0 },
				/* ACPI VFE1 P-states / mmcc ftbl_vfe0_clk_src */
				{ 80000000, 100000000, 200000000, 320000000,
				  400000000, 480000000, 533330000, 600000000 },
				{ 0 },
				{ 0 },
