 ...
 * camss-vfe-4-6.c
 *
 * Qualcomm MSM Camera Subsystem - VFE (Video Front End) Module v4.6
 * (MSM8994 / qcom,vfe46). IRQ + reset match v4.7; WM/RDI/CAMIF/QoS
 * offsets are from 3.10 msm_isp46.c. Do not reuse vfe_ops_4_1 or
 * vfe_ops_4_7 on 8x94. PIX demux/scale/crop remain 4.7 numbers and
 * are unverified — RDI only until those are mapped.
 *
...
#define VFE_0_BUS_IMAGE_MASTER_n_WR_CFG(n)		(0x0a0 + 0x24 * (n))
#define VFE_0_BUS_IMAGE_MASTER_n_WR_CFG_WR_PATH_SHIFT	0
#define VFE_0_BUS_IMAGE_MASTER_n_WR_PING_ADDR(n)	(0x0a4 + 0x24 * (n))
#define VFE_0_BUS_IMAGE_MASTER_n_WR_PONG_ADDR(n)	(0x0a8 + 0x24 * (n))
#define VFE_0_BUS_IMAGE_MASTER_n_WR_ADDR_CFG(n)		(0x0ac + 0x24 * (n))
#define VFE_0_BUS_IMAGE_MASTER_n_WR_ADDR_CFG_FRM_BASED_SHIFT	1
#define VFE_0_BUS_IMAGE_MASTER_n_WR_ADDR_CFG_FRM_DROP_PER_SHIFT	2
#define VFE_0_BUS_IMAGE_MASTER_n_WR_ADDR_CFG_FRM_DROP_PER_MASK	(0x1f << 2)
#define VFE_0_BUS_IMAGE_MASTER_n_WR_UB_CFG(n)		(0x0b0 + 0x24 * (n))
#define VFE_0_BUS_IMAGE_MASTER_n_WR_UB_CFG_OFFSET_SHIFT	16
#define VFE_0_BUS_IMAGE_MASTER_n_WR_IMAGE_SIZE(n)	(0x0b4 + 0x24 * (n))
#define VFE_0_BUS_IMAGE_MASTER_n_WR_BUFFER_CFG(n)	(0x0b8 + 0x24 * (n))
...
#define VFE_0_BUS_PING_PONG_STATUS	0x2a8

#define VFE_0_BUS_BDG_CMD		0x374
#define VFE_0_BUS_BDG_CMD_HALT_REQ	1

#define VFE_0_BUS_BDG_QOS_CFG_0		0x378
#define VFE_0_BUS_BDG_QOS_CFG_0_CFG	0xaaa9aaa9
#define VFE_0_BUS_BDG_QOS_CFG_1		0x37c
#define VFE_0_BUS_BDG_QOS_CFG_2		0x380
#define VFE_0_BUS_BDG_QOS_CFG_3		0x384
#define VFE_0_BUS_BDG_QOS_CFG_4		0x388
#define VFE_0_BUS_BDG_QOS_CFG_5		0x38c
#define VFE_0_BUS_BDG_QOS_CFG_6		0x390
#define VFE_0_BUS_BDG_QOS_CFG_7		0x394
#define VFE_0_BUS_BDG_QOS_CFG_7_CFG	0x0001aaa9

#define VFE_0_BUS_BDG_DS_CFG_0		0xbd8
#define VFE_0_BUS_BDG_DS_CFG_0_CFG	0xcccc1111
#define VFE_0_BUS_BDG_DS_CFG_1		0xbdc
#define VFE_0_BUS_BDG_DS_CFG_2		0xbe0
#define VFE_0_BUS_BDG_DS_CFG_3		0xbe4
#define VFE_0_BUS_BDG_DS_CFG_4		0xbe8
#define VFE_0_BUS_BDG_DS_CFG_5		0xbec
#define VFE_0_BUS_BDG_DS_CFG_6		0xbf0
#define VFE_0_BUS_BDG_DS_CFG_7		0xbf4
#define VFE_0_BUS_BDG_DS_CFG_8		0xbf8
#define VFE_0_BUS_BDG_DS_CFG_9		0xbfc
#define VFE_0_BUS_BDG_DS_CFG_10		0xc00
#define VFE_0_BUS_BDG_DS_CFG_11		0xc04
#define VFE_0_BUS_BDG_DS_CFG_12		0xc08
#define VFE_0_BUS_BDG_DS_CFG_13		0xc0c
#define VFE_0_BUS_BDG_DS_CFG_14		0xc10
#define VFE_0_BUS_BDG_DS_CFG_15		0xc14
#define VFE_0_BUS_BDG_DS_CFG_16		0xc18
#define VFE_0_BUS_BDG_DS_CFG_16_CFG	0x00000103

#define VFE_0_RDI_CFG_x(x)		(0x39c + (0x4 * (x)))
...
#define VFE_0_CAMIF_CMD				0x3a8
#define VFE_0_CAMIF_CMD_DISABLE_FRAME_BOUNDARY	0
#define VFE_0_CAMIF_CMD_ENABLE_FRAME_BOUNDARY	1
#define VFE_0_CAMIF_CMD_NO_CHANGE		3
#define VFE_0_CAMIF_CMD_CLEAR_CAMIF_STATUS	BIT(2)
#define VFE_0_CAMIF_CFG				0x3ac
#define VFE_0_CAMIF_CFG_VFE_OUTPUT_EN		BIT(6)
#define VFE_0_CAMIF_FRAME_CFG			0x3b4
#define VFE_0_CAMIF_WINDOW_WIDTH_CFG		0x3b8
#define VFE_0_CAMIF_WINDOW_HEIGHT_CFG		0x3bc
#define VFE_0_CAMIF_SUBSAMPLE_CFG		0x3c0
#define VFE_0_CAMIF_IRQ_FRAMEDROP_PATTERN	0x3c4
#define VFE_0_CAMIF_IRQ_SUBSAMPLE_PATTERN	0x3c8
#define VFE_0_CAMIF_STATUS			0x3d0
#define VFE_0_CAMIF_STATUS_HALT			BIT(31)

#define VFE_0_REG_UPDATE		0x3d8
...
{
	/* 3.10 first_start writes 0x1FF — bits 0–8, no IDLE_CGC. */
	u32 reset_bits = VFE_0_GLOBAL_RESET_CMD_DSP		|
...
{
	if (enable)
		writel_relaxed(0x1, vfe->base + VFE_0_BUS_CFG);
	else
...
static const struct vfe_hw_ops_gen1 vfe_ops_gen1_4_6 = {
...
static void vfe_subdev_init(struct device *dev, struct vfe_device *vfe)
{
	...
	vfe->ops_gen1 = &vfe_ops_gen1_4_6;
	vfe->video_ops = vfe_video_ops_gen1;
}

const struct vfe_hw_ops vfe_ops_4_6 = {
